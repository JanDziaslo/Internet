...
<div class="container">
    <div id="szukajka-tabela-zesp">
        <form action="" method="post" id="szukajka-zesp">
            <div class="row my-5">
                <div class="col-md-4">
                    <input type="text" class="form-control" name="search" id="search-zesp" placeholder="Wyszukaj zespół" />
                </div>
                <div class="col-md-1 text-left">
                    <input type="submit" class="btn btn-primary" name="submit" value="Szukaj" />
                </div>
                <div class="col-md-3 ">
                    <button type="button" class="btn btn-danger" onclick="document.getElementById('search-zesp').value=''; getZespoly()">Resetuj</button>
                </div>
                <div class="col-md-4 text-end">
                    <a class="btn btn-success" onclick="dodawanie_zesp()" role="button">Dodaj Zespół</a>
                </div>
            </div>
        </form>
        <div class="row">
