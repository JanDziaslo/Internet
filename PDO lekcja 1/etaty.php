...
<div class="container">
    <div id="szukajka-tabela-etat">
        <form action="" method="post" id="szukajka-etat">
            <div class="row my-5">
                <div class="col-md-4">
                    <input type="text" class="form-control" name="search" id="search-etat" placeholder="Wyszukaj etat" />
                </div>
                <div class="col-md-1 text-left">
                    <input type="submit" class="btn btn-primary" name="submit" value="Szukaj" />
                </div>
                <div class="col-md-3 ">
                    <button type="button" class="btn btn-danger" onclick="document.getElementById('search-etat').value=''; getEtaty()">Resetuj</button>
                </div>
                <div class="col-md-4 text-end">
                    <a class="btn btn-success" onclick="dodawanie_etat()" role="button">Dodaj Etat</a>
                </div>
            </div>
        </form>
        <div class="row">
