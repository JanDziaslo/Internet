    ...
    <?php else: ?>
                        ...
                        if (response.success) {
                            ...
                            setTimeout(function() {
                                if (window.parent && window.parent.navigateTo) {
                                    window.parent.navigateTo('admin.php');
                                } else {
        ...
        <?php else: ?>
            ...
            $(function() {
                ...
                $(document).off('.adminMod');

                $(document).on('click.adminMod', '.approve-btn', function() {
                    var id = $(this).data('id');
                ...
                $(document).on('click.adminMod', '.reject-btn', function() {
                    var id = $(this).data('id');
                ...
                $(document).on('click.adminMod', '.delete-btn', function() {
                    var id = $(this).data('id');
